...
def get_subtitles(videoid, lang): 
  ...
  try: 
    ...
    print("transcript found for:", transcript.language_code)
    # print(f'transcript generated by YT: {transcript.is_generated}')
    # print(transcript.fetch())
    return False, True # auto, manual
          
  except youtube_transcript_api._errors.TranscriptsDisabled: 
      # print('Transcript not available for this video')
      return
  except youtube_transcript_api._errors.NoTranscriptFound:
      # print('Transcript not found for', lang)
      return
